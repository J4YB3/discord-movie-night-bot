        ...
        bot_data.bot.send_embed(
            ...
            |embed| {
                embed
                    ...
                    .description(
                        "Leider besitzt du nicht die benötigte Berechtigung um das zu tun.",
                    )
        ...
        bot_data.bot.send_embed(
            ...
            |embed| {
                embed
                    ...
                    .description(
                        "Bitte beende zunächst die Abstimmung bevor du eine neue eröffnest.",
                    )
                    .color(crate::COLOR_ERROR)
            },
        ),
    ...
    crate::general_behaviour::trace_nonfatal_discord_result(
        bot_data.bot.send_embed(
            bot_data
                ...
                .as_ref()
                .expect(
                    "Passing message to send_message::movie_not_found_in_watchlist_error failed.",
                )
                .channel_id,
            "",
            |embed| {
...
pub fn vote_not_found_error(bot_data: &mut crate::BotData, user_id: &discord::model::UserId) {
    match bot_data.bot.create_private_channel(*user_id) {
        Ok(private_channel) => crate::general_behaviour::trace_nonfatal_discord_result(bot_data.bot.send_embed(
            private_channel.id,
            "",
            |embed| embed
