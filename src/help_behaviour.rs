...
pub fn show_help(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help function failed.");

    let help_str = "Einige Kommandos besitzen Aliase, die kürzer als das normale Kommando sind.
...
pub fn show_help_help(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_help function failed.");

    let help_str = "Zeigt eine allgemeine Hilfe, sowie eine Liste aller Kommandos an.
...
pub fn show_help_quit(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_quit function failed.");
...
pub fn show_help_add_movie(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_add_movie function failed.");

    let help_str = r"Sucht nach einem Film auf TMDb und fügt ihn zur Liste hinzu, wenn dieser vom Nutzer bestätigt wird. Es kann auch ein IMDb-Link oder ein TMDb-Link angegeben werden.
...
pub fn show_help_remove_movie(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_remove_movie function failed.");

    let help_str = "Ermöglicht es dir einen Film von der Filmliste zu entfernen.
...
pub fn show_help_watchlist(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_watchlist function failed.");

    let help_str = "Zeigt die Filmliste an.
...
pub fn show_help_prefix(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_prefix function failed.");
...
pub fn show_help_history(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_history function failed.");
...
pub fn show_help_status(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_set_status function failed.");
...
pub fn show_help_set_status_unavailable(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_set_status_unavailable function failed.");

    let help_str = "Setzt den Status eines Films mit der ID direkt zu `Unavailable`
    Der Status `Unavailable` wird bei der Zählung der Filme pro Nutzer ignoriert.
...
pub fn show_help_set_status_watched(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_set_status_watched function failed.");
...
pub fn show_help_show_movie(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_show_movie function failed.");

    let help_str = "Zeigt Informationen zu einem Film von der Watch List oder der History an.
...
pub fn show_help_search_movie(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_search_movie function failed.");
...
pub fn show_help_create_vote(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_create_vote function failed.");
...
pub fn show_help_send_vote(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_send_vote function failed.");
...
pub fn show_help_close_vote(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_close_vote function failed.");

    let help_str = "Beendet deine eigene Abstimmung, sofern du eine hast.
...
pub fn show_help_movie_limit(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_movie_limit function failed.");
...
pub fn show_help_movie_vote_limit(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_movie_vote_limit function failed.");
...
pub fn show_help_random_movie_vote(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_random_movie_vote function failed.");
...
pub fn show_help_close_movie_vote(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_close_movie_vote function failed.");
...
pub fn show_help_info(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_info function failed.");

    let help_str = "Zeigt Informationen über den Bot an.
...
pub fn show_help_save(bot_data: &crate::BotData) {
    ...
    let help_str = "Speichert alle Daten des Bots in die Speicherdatei.
...
pub fn show_help_count_movies(bot_data: &crate::BotData) {
    let message = bot_data
        .message
        .as_ref()
        .expect("Passing message to show_help_count_movies function failed.");

    let help_str = "Zeigt dir an, wie viele Filme auf der Filmliste aktuell von dir sind.
